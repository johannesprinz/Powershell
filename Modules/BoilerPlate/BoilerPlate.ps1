...
Task Make-Module{
	...
	Get-Content -Path "$baseDir\default.ps1" | ForEach-Object{$_.Replace('Include ".\BoilerPlate.ps1"',"").Replace("BoilerPlate",$moduleName)} | Out-File -FilePath "$targetPath\default.ps1" -Encoding UTF8 	
